...
def export_package(manifest, dest):
    ...
    print(f"[INFO] exporting into directory {abs_dest}")
    ...
    for name, hostname in files:
        ...
        if hostname.startswith("->"):
            ...
            print(f"[INFO] added link {name} -> {link_source}")

        elif os.path.islink(hostname):
